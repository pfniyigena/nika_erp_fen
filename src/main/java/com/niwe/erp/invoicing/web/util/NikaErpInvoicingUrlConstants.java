package com.niwe.erp.invoicing.web.util;

public class NikaErpInvoicingUrlConstants {

	private NikaErpInvoicingUrlConstants() {
	...
	/**
	 * The INVOICE_LIST_PAGE
	 */
	public static final String INVOICE_LIST_PAGE = "invoices/list";
	/**
	 * The INVOICE_ADD_FORM
	 */
