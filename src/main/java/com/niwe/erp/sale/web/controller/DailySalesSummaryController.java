...
public class DailySalesSummaryController {
    ...
    public String viewInvoice(@PathVariable String id, Model model) {
       ...
       // model.addAttribute("taxes", taxes);
        return NiweErpSaleUrlConstants.DAILT_SALES_SUMMARY_DATAILS_PAGE;  // ✅ Print view
    }
    @GetMapping("/filter")
    ...
    public ResponseEntity<InputStreamResource> exportDailySalesSummaryToPdf(@PathVariable String id, Model model) throws IOException {
    	DailySalesSummary summary = dailySalesSummaryService.findById(id);
