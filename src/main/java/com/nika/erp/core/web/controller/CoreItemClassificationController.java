...
@Slf4j
@Controller
@RequestMapping(value = NikaErpCoreUrlConstants.ITEM_CLASSIFICATIONS_URL)
@AllArgsConstructor
public class CoreItemClassificationController {
	...
	public String listClassifications(Model model) {
		...
		return NikaErpCoreUrlConstants.ITEM_CLASSIFICATIONS_LIST_PAGE;
	}
	...
	public String newClassification(Model model) {
		...
		return NikaErpCoreUrlConstants.ITEM_CLASSIFICATIONS_ADD_FORM_PAGE;
	}
	...
	public String saveClassification(CoreItemClassification classification, RedirectAttributes redirectAttrs,
		...
		return NikaErpCoreUrlConstants.ITEM_CLASSIFICATIONS_LIST_REDITECT_URL;
	}
